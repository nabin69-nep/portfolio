...
export const TextRevealCard = ({
  ...
  return (
    (<div
      ...
      ref={cardRef}
      className={cn(
        "   text-center rounded-lg px-8  relative overflow-hidden",
        className
      )}>
      {children}
      <div className=" relative flex items-center overflow-hidden">
        <motion.div
          ...
          <p
            ...
            className="text-base sm:text-[3rem] py-10 font-bold text-black dark:text-white bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300">
            {revealText}
          </p>
        </motion.div>
        <motion.div
        ...
        <div
          ...
          <p
            className="text-2xl sm:text-[3rem] py-10 font-bold bg-clip-text text-transparent bg-[#323238]">
            {text}
          </p>
          <MemoizedStars />
        </div>
